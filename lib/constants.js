module.exports = {
  ...
  FLICKR_PHOTOS_PROGRESS_LABEL: 'photo pages loaded',
  FLICKR_PHOTOS_LIST_PROGRESS_LABEL: 'photos synced',

  FLICKR_PHOTOSETS_PAGE_SIZE: 500,
  FLICKR_PHOTOSETS_PROGRESS_LABEL: 'photoset pages loaded',
  FLICKR_PHOTOSETS_LIST_PROGRESS_LABEL: 'photosets synced',
