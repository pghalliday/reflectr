...
module.exports = {
  ...
  // Exponential backoff etry parameters where n is the retry attempt the wait is
  // calculated as INITIAL_WAIT * (Math.pow(BACKOFF_FACTOR, n)
  RETRY_DOWNLOAD_INITIAL_WAIT: 1000,
  RETRY_DOWNLOAD_BACKOFF_FACTOR: 2,
  RETRY_DOWNLOAD_MAX_WAIT: 60*60*1000,
  RETRY_DOWNLOAD_MAX_RETRIES: 25,
  RETRY_API_INITIAL_WAIT: 1000,
  RETRY_API_BACKOFF_FACTOR: 2,
  RETRY_API_MAX_WAIT: 60*60*1000,
  RETRY_API_MAX_RETRIES: 25,
